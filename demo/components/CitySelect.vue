	...
	<scroll-view :scroll-y="true" :scroll-top="scrollTop" class="city-select">
		...
		<view v-if="!showSearch">
			<view class="city-category" v-for="group in cities" :key="group.group">
				...
				<view @click="selectCity(city.name)" class="address-item address-list-item"
					v-for="city in group.cities" :key="city.pinyin">{{city.name}}</view>
			</view>
		...
		<view class="search-result" v-else>
			<view @click="selectCity(city.name)" class="address-item address-list-item"
				v-for="city in searchResult" :key="city.pinyin">{{city.name}}</view>
		</view>
	</scroll-view>
</template>
